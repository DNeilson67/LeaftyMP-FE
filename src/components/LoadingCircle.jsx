  ...
  return (
    <>
      <div className="loading-circle-container">
        ...
        <motion.span className="loading loading-spinner" style={{ color: "#0F7275", marginBottom: "-5px"}} transition = {{duration: 0.5, type: "spring"}} animate={{ width: "300px", height: "300px" }} initial = {{width: "0px", height: "0px"}}> </motion.span>
      </div>
    </>
  );
}

...
const Circle = forwardRef(function Circle({ className, children, padding = true }, ref) {
    return (
        <div
            ref={ref}
            className={cn(
                `z-10 flex items-center justify-center rounded-full border-2 border-border border-white shadow-md bg-white ${padding && "p-2"}`,
                className
            )}
        >
            {children}
...
export default function LoadingAnimation({
    ...
    return (
        <div
            className={cn(
                "relative insets-0 flex w-full items-center justify-center overflow-hidden rounded-lg bg-background p-10",
                className,
            )}
            ref={containerRef}
        >
            <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
                <div className="flex flex-col justify-center gap-2">
                    <Circle ref={div1Ref} className="bg-[#C0CD30]">
                        <img src={centra} className="w-10 h-10"></img>
                    </Circle>
                    <Circle ref={div2Ref} className="bg-[#C0CD30]">
                        <img src={centra} className="w-10 h-10"></img>
                    </Circle>
                    <Circle ref={div3Ref} className="bg-[#C0CD30]">
                        <img src={centra} className="w-10 h-10"></img>
                    </Circle>
                    <Circle ref={div4Ref} className="bg-[#C0CD30]">
                        <img src={centra} className="w-10 h-10"></img>
                    </Circle>
                    <Circle ref={div5Ref} className="bg-[#C0CD30]">
                        <img src={centra} className="w-10 h-10"></img>
                    </Circle>
                </div>
                <div className="flex flex-col justify-center">
                    <Circle ref={div6Ref} className="size-16" padding ={false}>
                        <img src={LeaftyLogo} className="w-24 h-24"></img>
                    </Circle>
                </div>
                <div className="flex flex-col justify-center">
                    <Circle ref={div7Ref} className="size-16" padding ={false}>
                        <img src={users} className="w-24 h-24"></img>
                    </Circle>
                </div>
            </div>

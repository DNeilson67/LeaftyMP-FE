    ...
    return <>
        <div className='flex flex-col w-full'>
            <div className="flex flex-row gap-2 items-center">
                <span className='text-2xl font-semibold'>Which kind of Centra do you prefer?</span>
                <button className="" onClick={() => document.getElementById('info_centra').showModal()}><InfoOutlined className="text-[#0F7275]" /></button>
            </div>
            <span className='text-[#79B2B7] text-xl'>Please select only one option</span>
            <hr className='w-1/12 border-[#0F7275] rounded border-2 my-2'></hr>
            <WideButtonRow item={preferredCentra} setItem={setPreferredCentra} widthClass="w-1/3" Buttons={Buttons} width={"1/4"} />
            {
            ...
            <dialog id="info_centra" className="modal">
                <div class="modal-box">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row gap-2 items-center">
                            <img src={bestquality} className="w-8 h-8"></img>
                            <span className="font-semibold text-[#0F7275] text-xl">Best Quality</span>
                        </div>
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            <img src={instant} className="w-8 h-8"></img>
                            <span className="font-semibold text-[#0F7275] text-xl">Instant</span>
                        </div>
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            <img src={closest} className="w-8 h-8"></img>
                            <span className="font-semibold text-[#0F7275] text-xl">Closest Proximity</span>
                        </div>
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            <img src={customized} className="w-8 h-8"></img>
                            <span className="font-semibold text-[#0F7275] text-xl">Customized</span>
                        </div>
